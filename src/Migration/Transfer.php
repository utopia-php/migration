...
class Transfer
{
    ...
    public const GROUP_AUTH_OAUTH2_RESOURCES = [
        Resource::TYPE_OAUTH2_AMAZON,
        Resource::TYPE_OAUTH2_APPLE,
        Resource::TYPE_OAUTH2_AUTH0,
        Resource::TYPE_OAUTH2_AUTHENTIK,
        Resource::TYPE_OAUTH2_AUTODESK,
        Resource::TYPE_OAUTH2_BITBUCKET,
        Resource::TYPE_OAUTH2_BITLY,
        Resource::TYPE_OAUTH2_BOX,
        Resource::TYPE_OAUTH2_DAILYMOTION,
        Resource::TYPE_OAUTH2_DISCORD,
        Resource::TYPE_OAUTH2_DISQUS,
        Resource::TYPE_OAUTH2_DROPBOX,
        Resource::TYPE_OAUTH2_ETSY,
        Resource::TYPE_OAUTH2_FACEBOOK,
        Resource::TYPE_OAUTH2_FIGMA,
        Resource::TYPE_OAUTH2_FUSIONAUTH,
        Resource::TYPE_OAUTH2_GITHUB,
        Resource::TYPE_OAUTH2_GITLAB,
        Resource::TYPE_OAUTH2_GOOGLE,
        Resource::TYPE_OAUTH2_KEYCLOAK,
        Resource::TYPE_OAUTH2_KICK,
        Resource::TYPE_OAUTH2_LINKEDIN,
        Resource::TYPE_OAUTH2_MICROSOFT,
        Resource::TYPE_OAUTH2_NOTION,
        Resource::TYPE_OAUTH2_OIDC,
        Resource::TYPE_OAUTH2_OKTA,
        Resource::TYPE_OAUTH2_PAYPAL,
        Resource::TYPE_OAUTH2_PODIO,
        Resource::TYPE_OAUTH2_SALESFORCE,
        Resource::TYPE_OAUTH2_SLACK,
        Resource::TYPE_OAUTH2_SPOTIFY,
        Resource::TYPE_OAUTH2_STRIPE,
        Resource::TYPE_OAUTH2_TRADESHIFT,
        Resource::TYPE_OAUTH2_TWITCH,
        Resource::TYPE_OAUTH2_WORDPRESS,
        Resource::TYPE_OAUTH2_X,
        Resource::TYPE_OAUTH2_YAHOO,
        Resource::TYPE_OAUTH2_YANDEX,
        Resource::TYPE_OAUTH2_ZOHO,
        Resource::TYPE_OAUTH2_ZOOM,
    ];
    ...
    public const GROUP_AUTH_RESOURCES = [
        ...
        ...self::GROUP_AUTH_OAUTH2_RESOURCES,
    ];
